...
public class RandomNameGenerator {
    ...
    public String[] nextPersonFields() {
        ...
        String domainName=company.toLowerCase(Locale.ENGLISH).replaceAll(" ", "").replace(".","").replace(",", "") + ".com";
        String userName=(fn+"."+ln).toLowerCase(Locale.ENGLISH).replaceAll(" ", "").replace(",", "");
